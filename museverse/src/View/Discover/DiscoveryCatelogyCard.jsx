...
function DiscoveryCatelogyCard({ id, name, description, image, setPlayingTrack, setPlayingID, playingID, setTrackInAlbum }) {
  ...
  return (
    <div
      className="bg-[#181818] h-76 w-48 px-3 flex flex-col items-center rounded-lg gap-y-3 hover:bg-[#282828] cursor-pointer"
...
export default DiscoveryCatelogyCard;
