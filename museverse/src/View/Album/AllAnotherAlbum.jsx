            ...
            .then(response => {
                ...
                axios(`https://api.spotify.com/v1/artists/${artistID}/albums?include_groups=album,single&market=VN`, {
                    ...
                    .then(json => {
                        ...
                        // console.log(json.data.items[0].artists[0].name)
                        const name = json.data.items[0].artists[0].name;
                        setArtistName(name);
                        setLoading(false)
                    })
                    .catch(error => {
    ...
    return (
        <div className='h-screen overflow-y-scroll w-full pb-32'>
            <div className='flex flex-row justify-between'>
                <div className='flex ml-12 mt-8 text-white font-bold text-xl'>
                    {artistName}
                </div>
...
export default AllAnotherAlbum